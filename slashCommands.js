...
const slashCommands = [
  ...
  new SlashCommandBuilder()
    ...
    .setDescription("Add coins to a user on the leaderboard")
    .addUserOption(option =>
      option
        .setName("user")
  ...
  new SlashCommandBuilder()
    ...
    .setDescription("Add likes to a user on the leaderboard")
    .addUserOption(option =>
      option
        .setName("user")
  ...
  new SlashCommandBuilder()
    .setName("autofill")
    .setDescription("Autofill a strike dispute into the current ticket for admin review"),

  new SlashCommandBuilder()
    .setName("revokestrike")
    .setDescription("Revoke strikes from a user (admin only)")
    .addUserOption(option =>
    ...
    .addIntegerOption(option =>
      option
        .setName("number")
        .setDescription("How many strikes to revoke")
        .setRequired(true)
        .setMinValue(1)
    )
    .addStringOption(option =>
      option.setName("reason").setDescription("Why the strike is being revoked").setRequired(false)
    )
];

function getSlashCommandPayloads() {
